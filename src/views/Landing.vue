            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">We Design and Build
                                    <span>Creative Digital Solutions for your Business</span>
                                </h1>
                                <p class="lead  text-white">Id8 Creatives is a creative agency proffering overall branding and creative solutions to business brands and personas.</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">We Brand</h6>
                                    <p class="description mt-3">We conceptualize your brand, run your campaigns and generate your desired leads. We make it look easy</p>
                                    <div>
                                        <badge type="primary" rounded>Content creation</badge>
                                        <badge type="primary" rounded>360 Branding</badge>
                                        <badge type="primary" rounded>Ad creation</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">We Design</h6>
                                    <p class="description mt-3">Our Creative visual designs and concepts give clothing to Brands and Organizations.</p>
                                    <div>
                                        <badge type="success" rounded>UI/UX Design</badge>
                                        <badge type="success" rounded>Graphics Design</badge>
                                        <badge type="success" rounded>Motion Graphics</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="ni ni-creative" type="warning" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-warning text-uppercase">We Build</h6>
                                    <p class="description mt-3">We develop websites with appealing designs that gives amazing user experiences.</p>
                                    <div>
                                        <badge type="warning" rounded>Website Development</badge>
                                        <badge type="warning" rounded>Mobile App</badge>
                                        <badge type="warning" rounded>SaaS App Development</badge>
                                    </div>
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-md-6 order-md-2">
                        <img src="https://res.cloudinary.com/unitech-global-resource/image/upload/v1594172818/ID8-logo_2x-Landmark_c4uveg.png" class="img-fluid floating">
                    </div>
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            <icon name="ni ni-settings-gear-65" class="mb-5" size="lg" type="success" shadow
                                  rounded></icon>
                            <h3>About Us</h3>
                            <p>We are particular about bringing ideas to life through creativity, innovation and excellence. 
                                Creativity serves as the basic essence of our efforts as a firm and we offer the best creative digital assets at affordable rates. 
                                Id8 Creatives offers a wide range of concepts brimming with creativity and craft.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-settings-gear-65"></badge>
                                        <h6 class="mb-0">Carefully crafted brand designs</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-html5"></badge>
                                        <h6 class="mb-0">Amazing page Website User experience</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'https://res.cloudinary.com/unitech-global-resource/image/upload/v1587495126/jjw_hoyuya.png'"
                                 class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                 style="width: 200px;">
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Olaide Okediji</span>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Toyeeb </span>
                                    <small class="h6 text-muted">Web Developer</small>
                                </h5>
                                <div class="mt-3">
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            <img v-lazy="'https://res.cloudinary.com/unitech-global-resource/image/upload/v1594174792/1abcd_gytjyb.png'"
                                 class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                                 style="width: 200px;">
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Oluchi </span>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Chimex</span>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Victor</span>
                                    <small class="h6 text-muted">Motion Graphics</small>
                                </h5>
                                <div class="mt-3">
                                    <base-button tag="a" href="#" type="warning" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Temitope </span>
                                    <small class="h6 text-muted">UIUX Designer</small>
                                </h5>
                                <div class="mt-3">
                                    <base-button tag="a" href="#" type="primary" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                <h5 class="title">
                                    <span class="d-block mb-1">Tal </span>
                                    <small class="h6 text-muted">Content Writer</small>
                                </h5>
                                <div class="mt-3">
                                    <base-button tag="a" href="#" type="info" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
